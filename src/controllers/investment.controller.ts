...
import { getAll, insertRecord } from '../services/investment.service';
...
export const save = async (req: Request, res: Response) => {
    try{
        ...
        ResponseSuccess(res, 201, [monto], 'El monto de inversión se insertó correctamente.');
    }catch(err){
        ResponseSuccess(res, 201, [], 'El monto de inversión se insertó correctamente.');
    }
}
...
export const update = async (req: Request, res: Response) => {    
    try{
        ...
        ResponseSuccess(res, 201, [montoAhorro], 'El monto de inversión se actualización correctamente.');
    }catch(err){
        ResponseSuccess(res, 201, [], 'El monto de inversión se actualización correctamente.');
    }
}