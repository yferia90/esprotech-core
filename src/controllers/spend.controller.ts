...
import { getAll, insertRecord } from '../services/spend.service';
...
export const save = async (req: Request, res: Response) => {
    try{
        ...
        ResponseSuccess(res, 201, [monto], 'El monto de gasto se insertó correctamente.');
    }catch(err){
        ResponseSuccess(res, 201, [], 'El monto de gasto se insertó correctamente.');
    }
}
